...
void setup()
{
  ...
  delay(5000);
  Serial3.begin(9600);
  mp3.begin(Serial3, MP3_SERIAL_TIMEOUT, DFPLAYER_MINI, false); //"DFPLAYER_MINI" see NOTE, false=no response from module after the command
...
//mp3.playFolder(1, 2); //1=folder/2=track, folder name must be 01..99 & files in folder must start with 3 decimal digits with leading zeros
  ...
  delay(30000);         //play for 60 seconds
